...
\item the \emph{augmented dataset}, as described in the previous section;% obtained starting from the regular dataset and enriching it with  repeated down-samplings of the larger dataset.
...
\begin{table}
  \begin{center}
    \begin{tabular}{ c | l | c }
      \toprule
        \multicolumn{1}{|c|}{\underline{Group}} & \multicolumn{1}{|c|}{\underline{Type}} & \multicolumn{1}{|c|}{\underline{Interval}}  \\
       \midrule
       & &  \\
