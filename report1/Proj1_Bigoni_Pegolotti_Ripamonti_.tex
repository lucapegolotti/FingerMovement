...
\item \textbf{Simple convolutional linear network (M2).} We consider two convolutional layers --  combined with average pooling and ReLU non-linearities -- followed by two additional linear layers. The kernels are translated in the direction of the timesteps.
\begin{figure}[h]
\centering
