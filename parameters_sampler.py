...
class ParametersSampler():
    def __init__(self):
        self.parameters = {'batch_size': UniformParameter("int", 1, 10, 100),
                           'eta': UniformParameter("float", 1, 0.01, 0.02),
                           'epochs': UniformParameter("int", 1, 100, 1000),
                           'dropout': UniformParameter("float", 1, 0.1, 0.5),
                           'momentum': UniformParameter("float", 1, 0.5, 0.9),
                           'leakyRelu': UniformParameter("float", 1, 0.01, 0.1),
                           'l1_penalization': UniformParameter("float", 1, 0.0001, 0.001),
                           'l2_penalization': UniformParameter("float", 1, 0.0001, 0.001),
                           'hidden1': UniformParameter("int", 1, 16, 512),
                           'hidden2': UniformParameter("int", 1, 16, 512)}
    def showMe(self):
