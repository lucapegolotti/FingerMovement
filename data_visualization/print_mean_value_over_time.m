...
for i = 1:numel(vec_ch)
   ...
   plot(t,m_test_r{vec_ch(i)},'k-x','Linewidth',2)
   plot(t,m_test_l{vec_ch(i)},'m->','Linewidth',2)
...
%% Smoothing
% load('../data_bci/train_smooth1_w5_or3.txt');
% 
% % Train - first 100
% d_train = dlmread('../data_bci/train_smooth1_w7_or3.txt');
% d_train = d_train(:,2:end);
% [ m_train_r, m_train_l, data_channels_train_right, data_channels_train_left ] = compute_mean( d_train,output_train,n_times );
% 
% % Test 
